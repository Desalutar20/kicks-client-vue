...
import { updateProduct } from '@/modules/admin/modules/products/api/admin-products.api'
...
export const useUpdateProduct = (
  options?: MutationOptions<ApiSuccessResponse<AdminProduct>, UpdateProductInput>,
) => {
